...
"resource": {
  ...
  "rules":[
    [["if",0],["add",0,1,25,29,35,36,45,59,64,27,42,38]],
    [["if",0,4],["add",2,7]],
    [["if",0,5],["add",3,8]],
    [["if",0,6],["add",4,39,46]],
    [["if",0,8,9],["add",5,58]],
    ...
    [["if",13],["add",10,22,23,26,28,37,52,53,54,56,60,61,62,63,65,66]],
    [["if",14],["add",11]],
...
Z.a.j=["google"],function(){(function(a){Z.__j=a;Z.__j.g="j";Z.__j.h=!0;Z.__j.b=0})(function(a){for(var b=String(a.vtp_name).split("."),c=V(b.shift()),d=0;d<b.length;d++)c=c&&c[b[d]];return c})}();Z.a.k=["google"],function(){(function(a){Z.__k=a;Z.__k.g="k";Z.__k.h=!0;Z.__k.b=0})(function(a){return ch(a.vtp_name,U("gtm.cookie",1),!!a.vtp_decodeCookie)[0]})}();
...
b&&(A+="&"+a+"="+b)}var q=ua,r=V("_gaq",[],!1),u=!1,t="";void 0==c.vtp_trackerName?t="gtm"+Sc()+".":""!==c.vtp_trackerName&&(t=c.vtp_trackerName+".");g("_setAccount","vtp_webPropertyId");d("_set","gtmid",sg(!0));
...
A){var C=function(a,b,c){for(var d=b.length-1;0<=d;d--){var e=b[d].split("=");if(e[0]===a)return e[1]||"1"}for(var g=c.length-1;0<=g;g--){var h=c[g].split("=");if(h[0]===a)return h[1]||"1"}},D=N(Yg()),L=vb(D,"query",void 0,void 0,void 0).split("&"),E=c.vtp_allowAnchor?vb(D,"fragment",void 0,void 0,void 0).split("&"):[];p("gclid",C("gclid",E,L));p("gclsrc",C("gclsrc",E,L));p("dclid",C("dclid",E,L));d("_set","campaignParams",A)}m("anonymizeIp",
...
var ba=function(){V("_gat")||c.vtp_gtmOnFailure()};if(c.vtp_doubleClick)b||(b=!0,S(X("https","http","://stats.g.doubleclick.net/dc.js",u),ba,c.vtp_gtmOnFailure));else if(!a){var M=c.vtp_useDebugVersion?".google-analytics.com/u/ga_debug.js":".google-analytics.com/ga.js";a=!0;S(X("https://ssl","http://www",M,u),ba,c.vtp_gtmOnFailure)}};Z.__ga=c;Z.__ga.g="ga";Z.__ga.h=!0;Z.__ga.b=0}();
...
g,k);qh("hl")}I(a.vtp_gtmOnSuccess)})}();
